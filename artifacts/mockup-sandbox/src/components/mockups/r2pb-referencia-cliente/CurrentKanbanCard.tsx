...
/**
 * Snapshot estático do cartão atual do Kanban; ações e API são intencionalmente
 * representadas apenas pela interface visual.
 */
export default function CurrentKanbanCard() {
  return (
        ...
        <div className="space-y-1 px-3 py-2 text-xs">
          ...
          <div className="mt-1 border-t border-gray-100 pt-1.5">
            <div className="flex items-center justify-between gap-2">
              <p className="truncate text-sm font-bold text-violet-600">265HO-036</p>
