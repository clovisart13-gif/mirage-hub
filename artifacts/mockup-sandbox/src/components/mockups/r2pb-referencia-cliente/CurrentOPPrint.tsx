...
export default function CurrentOPPrint() {
  return (
    <section className="r2pb-op-preview" aria-label="Pré-visualização de cartão de produção A4">
    ...
    <article className="r2pb-op-card">
      ...
      <div className="r2pb-op-body">
        <div className="r2pb-op-grid">
          <div>
            <Field label="Cliente" value="NOTES" /><Field label="Código / Referência" value="265HO-036" /><Field label="Modelo / Descrição" value="Hoodie oversized canguru" /><Field label="Fornecedor" value="FACÇÃO ALFA" />
            <div className="r2pb-op-row2"><Field label="Início" value="18/03/2026" /><Field label="Vencimento" value="28/03/2026" /></div>
          </div>
          <div>
            <Field label="Nº Pedido" value="PED-26-217" /><Field label="OP" value="OP-26-036" />
