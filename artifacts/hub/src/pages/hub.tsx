...
const APPS: AppDetail[] = [
  ...
  },
  {
    ...
    description: 'O Kanban de Produção da Mirage é um quadro visual de 14 etapas, do início ao faturamento e à conclusão. Cada ordem registra prazos, quantidades, perdas e movimentações para você acompanhar a produção pelo celular ou computador.',
    badge: 'Mais usado',
    color: 'bg-violet-600',
    colorHex: '#7C3AED',
    bgLight: 'bg-violet-50 dark:bg-violet-950',
    textColor: 'text-violet-600',
    quickFeatures: ['Gestão visual de OPs', '14 etapas no quadro', 'Custos por fase', 'Controle de prazos'],
    features: [
      ...
      { title: '14 etapas no quadro', description: 'Da fila de espera ao faturamento, com corte, costura, acabamento e expedição no percurso.', icon: Package },
      ...
      { title: 'Atraso visível no card', description: 'Veja os prazos e as ordens atrasadas diretamente no quadro.', icon: Zap },
    ...
    benefits: [
      { stat: '14', label: 'etapas no quadro' },
      { stat: '6', label: 'fases produtivas com CMO' },
      { stat: '+12 mil', label: 'peças acompanhadas na R2PB' },
    ],
    useCases: [
